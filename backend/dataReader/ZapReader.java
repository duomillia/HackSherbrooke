...
//	 * Zap location webservice, and then
//	 * places it in an array list of ZapDataObjects
//	 * 
//	 * receives:	none
//	 * returns:		ArrayList<ZapDataObject>
//	 * */
//	public ArrayList<ZapDataObject> getZapDataObjectList()
//	{
//		ArrayList<ZapDataObject> zdoList = new ArrayList<ZapDataObject>(); 
//		
//		String csvData = WebServiceReader.getStringFromURL(ConfigurationManager.getUrl("zap"));
//		
